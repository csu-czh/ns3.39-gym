...
#include "ns3/ipv4-czh-routing.h"
#include "ns3/ipv4.h"
 ...
 * \ingroup ipv4Helpers
 *
 * \brief Helper class that adds ns3::Ipv4CzhRouting objects
 *
 * This class is expected to be used in conjunction with
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class Ipv4CzhRoutingHelper : public Ipv4RoutingHelper
{
  public:
    /*
     * Construct an Ipv4CzhRoutingHelper object, used to make configuration
     * of static routing easier.
     */
    Ipv4CzhRoutingHelper();

    /**
     * \brief Construct an Ipv4CzhRoutingHelper from another previously
     * initialized instance (Copy Constructor).
     * \param o object to be copied
     */
    Ipv4CzhRoutingHelper(const Ipv4CzhRoutingHelper& o);

    // Delete assignment operator to avoid misuse
    Ipv4CzhRoutingHelper& operator=(const Ipv4CzhRoutingHelper&) = delete;

    /**
     * \returns pointer to clone of this Ipv4CzhRoutingHelper
     *
     * This method is mainly for internal use by the other helpers;
     * clients are expected to free the dynamic memory allocated by this method
     */
    Ipv4CzhRoutingHelper* Copy() const override;
     ...
     * \returns Ipv4CzhRouting pointer or 0 if not found
     */
    Ptr<Ipv4CzhRouting> GetCzhRouting(Ptr<Ipv4> ipv4) const;
