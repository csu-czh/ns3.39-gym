 ...
 */
#ifndef UDP_ORCA_CLIENT_SERVER_HELPER_H
#define UDP_ORCA_CLIENT_SERVER_HELPER_H
 ...
 */
class UdpOrcaServerHelper
{
  public:
    /**
     * Create UdpOrcaServerHelper which will make life easier for people trying
     ...
     */
    UdpOrcaServerHelper(Address address, uint16_t port);
     ...
     */
    Ptr<UdpOrcaServer> GetServer();
  private:
    ObjectFactory m_factory; //!< Object factory.
    Ptr<UdpOrcaServer> m_server; //!< The last created server application
};
 ...
 *
 */
class UdpOrcaClientHelper
{
  public:
    /**
     * Create UdpOrcaClientHelper which will make life easier for people trying
    ...
    UdpOrcaClientHelper(Address ip, uint16_t port);
    /**
     *  Create UdpOrcaClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
    ...
    UdpOrcaClientHelper(Address addr);
 ...
 */
class UdpOrcaTraceClientHelper
{
  public:
    /**
     * Create UdpOrcaTraceClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server.
     *
     */
    UdpOrcaTraceClientHelper();
     ...
     */
    UdpOrcaTraceClientHelper(Address ip, uint16_t port, std::string filename);
    /**
     * Create UdpOrcaTraceClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
     * addresses that do include a port value (e.g., InetSocketAddress and
     ...
     * \param filename the file from which packet traces will be loaded
     */
    UdpOrcaTraceClientHelper(Address addr, std::string filename);
...
#endif /* UDP_ORCA_CLIENT_SERVER_HELPER_H */
