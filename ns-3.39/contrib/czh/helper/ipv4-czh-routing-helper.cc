...
#include "ipv4-czh-routing-helper.h"
...
NS_LOG_COMPONENT_DEFINE("Ipv4CzhRoutingHelper");

Ipv4CzhRoutingHelper::Ipv4CzhRoutingHelper()
{
}

Ipv4CzhRoutingHelper::Ipv4CzhRoutingHelper(const Ipv4CzhRoutingHelper& o)
{
}

Ipv4CzhRoutingHelper*
Ipv4CzhRoutingHelper::Copy() const
{
    return new Ipv4CzhRoutingHelper(*this);
}

Ptr<Ipv4RoutingProtocol>
Ipv4CzhRoutingHelper::Create(Ptr<Node> node) const
{
    return CreateObject<Ipv4CzhRouting>();
}

Ptr<Ipv4CzhRouting>
Ipv4CzhRoutingHelper::GetCzhRouting(Ptr<Ipv4> ipv4) const
{
    NS_LOG_FUNCTION(this);
    Ptr<Ipv4RoutingProtocol> ipv4rp = ipv4->GetRoutingProtocol();
    NS_ASSERT_MSG(ipv4rp, "No routing protocol associated with Ipv4");
    if (DynamicCast<Ipv4CzhRouting>(ipv4rp))
    {
        NS_LOG_LOGIC("Static routing found as the main IPv4 routing protocol.");
        return DynamicCast<Ipv4CzhRouting>(ipv4rp);
    }
    if (DynamicCast<Ipv4ListRouting>(ipv4rp))
    {
        ...
        for (uint32_t i = 0; i < lrp->GetNRoutingProtocols(); i++)
        {
            ...
            if (DynamicCast<Ipv4CzhRouting>(temp))
            {
                NS_LOG_LOGIC("Found static routing in list");
                return DynamicCast<Ipv4CzhRouting>(temp);
            }
        }
    }
...
void
Ipv4CzhRoutingHelper::AddMulticastRoute(Ptr<Node> n,
                                           Ipv4Address source,
                                           Ipv4Address group,
                                           Ptr<NetDevice> input,
                                           NetDeviceContainer output)
{
    ...
    for (NetDeviceContainer::Iterator i = output.Begin(); i != output.End(); ++i)
    {
        ...
        NS_ASSERT_MSG(interface >= 0,
                      "Ipv4CzhRoutingHelper::AddMulticastRoute(): "
    ...
    Ipv4CzhRoutingHelper helper;
    Ptr<Ipv4CzhRouting> ipv4StaticRouting = helper.GetCzhRouting(ipv4);
    if (!ipv4StaticRouting)
    {
        NS_ASSERT_MSG(ipv4StaticRouting,
                      "Ipv4CzhRoutingHelper::SetDefaultMulticastRoute(): "
                      "Expected an Ipv4CzhRouting associated with this node");
    }
...
void
Ipv4CzhRoutingHelper::AddMulticastRoute(std::string nName,
                                           Ipv4Address source,
                                           Ipv4Address group,
                                           Ptr<NetDevice> input,
                                           NetDeviceContainer output)
...
void
Ipv4CzhRoutingHelper::SetDefaultMulticastRoute(Ptr<Node> n, Ptr<NetDevice> nd)
{
    Ptr<Ipv4> ipv4 = n->GetObject<Ipv4>();
...
void
Ipv4CzhRoutingHelper::SetDefaultMulticastRoute(Ptr<Node> n, std::string ndName)
{
...
void
Ipv4CzhRoutingHelper::SetDefaultMulticastRoute(std::string nName, Ptr<NetDevice> nd)
{
    Ptr<Node> n = Names::Find<Node>(nName);
    SetDefaultMulticastRoute(n, nd);
}
...
void
Ipv4CzhRoutingHelper::SetDefaultMulticastRoute(std::string nName, std::string ndName)
{
    Ptr<Node> n = Names::Find<Node>(nName);
    Ptr<NetDevice> nd = Names::Find<NetDevice>(ndName);
    SetDefaultMulticastRoute(n, nd);
