...
#ifndef IPV4_ORCA_ROUTING_H
#define IPV4_ORCA_ROUTING_H
 ...
 * protocol.
 *
 * The Ipv4OrcaRouting class inherits from the abstract base class
 ...
 */
class Ipv4OrcaRouting : public Ipv4RoutingProtocol
{
  public:
     ...
     *
     * \see Ipv4RoutingTableEntry
     * \see Ipv4OrcaRouting::RemoveRoute
     */
     ...
     *
     * \see Ipv4RoutingTableEntry
     * \see Ipv4OrcaRouting::GetRoute
     * \see Ipv4OrcaRouting::AddRoute
     */
     ...
     *
     * \see Ipv4MulticastRoutingTableEntry
     * \see Ipv4OrcaRouting::AddMulticastRoute
     */
    ...
    Ipv4Address getPeerAddress(Ipv4Address address);
  ...
  private:
    ...
    // m_next_hop[port].find({node_id,interface_id})
};

} // Namespace ns3

#endif /* IPV4_ORCA_ROUTING_H */
