...
#ifndef IPV4_ORCA_ROUTING_HELPER_H
#define IPV4_ORCA_ROUTING_HELPER_H

#include "ns3/ipv4-address.h"
#include "ns3/ipv4-routing-helper.h"
#include "ns3/ipv4-orca-routing.h"
#include "ns3/ipv4.h"
 ...
 * \ingroup ipv4Helpers
 *
 * \brief Helper class that adds ns3::Ipv4OrcaRouting objects
 *
 * This class is expected to be used in conjunction with
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class Ipv4OrcaRoutingHelper : public Ipv4RoutingHelper
{
  public:
    /*
     * Construct an Ipv4OrcaRoutingHelper object, used to make configuration
     * of static routing easier.
     */
    Ipv4OrcaRoutingHelper();

    /**
     * \brief Construct an Ipv4OrcaRoutingHelper from another previously
     * initialized instance (Copy Constructor).
     * \param o object to be copied
     */
    Ipv4OrcaRoutingHelper(const Ipv4OrcaRoutingHelper& o);

    // Delete assignment operator to avoid misuse
    Ipv4OrcaRoutingHelper& operator=(const Ipv4OrcaRoutingHelper&) = delete;

    /**
     * \returns pointer to clone of this Ipv4OrcaRoutingHelper
     *
     * This method is mainly for internal use by the other helpers;
     * clients are expected to free the dynamic memory allocated by this method
     */
    Ipv4OrcaRoutingHelper* Copy() const override;
     ...
     * \returns Ipv4OrcaRouting pointer or 0 if not found
     */
    Ptr<Ipv4OrcaRouting> GetOrcaRouting(Ptr<Ipv4> ipv4) const;
...
#endif /* IPV4_ORCA_ROUTING_HELPER_H */
